...
def find_urls(s):
    ...
    if len(urls) != 0: #making sure there is something in the url
        return urls #returns the url
    else:
       return ([]) #if there is no url features in string, then it returns an empty list.
